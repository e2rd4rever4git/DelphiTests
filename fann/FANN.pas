...
type
        ...
        ArrayOf_PFann_Type_Array = array [0..65535] of PFann_Type_Array; //e2rd
        PPFann_Type_Array = ^ArrayOf_PFann_Type_Array; //e2rd
...
var
        ...
        function fann_create_from_file(const configuration_file: PAnsiChar): PFann; cdecl;

        procedure fann_save(Ann: PFann; const Configuration_File: PAnsiChar); cdecl;
        ...
        {$IFNDEF FIXEDFANN}
              ...
              procedure fann_train_on_file(Ann: PFann; Filename: PAnsiChar; max_epochs: cardinal; epochs_between_reports: cardinal; desired_error: single); cdecl;
        ...
        function fann_read_train_from_file(const filename: PAnsiChar): PFann_Train_Data; cdecl;
